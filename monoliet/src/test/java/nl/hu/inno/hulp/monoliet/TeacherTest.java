...
import nl.hu.inno.hulp.monoliet.testvision.domain.OpenQuestion;
...
public class TeacherTest {
    ...
    public void acceptTest() throws Exception {
        ...
        nl.hu.inno.hulp.monoliet.testvision.domain.Test test=
                new nl.hu.inno.hulp.monoliet.testvision.domain.
                        Test(maker.getFirstName(), maker.getLastName(),question);
